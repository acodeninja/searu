//! @generated by `cargo xtask attack-sync` from MITRE ATT&CK Enterprise v19.2. Do not edit.

use super::{AttackTactic, AttackTechnique};

pub(super) static TACTICS: &[AttackTactic] = &[
    AttackTactic {
        id: "TA0001",
        name: "Initial Access",
    },
...
pub(super) static TECHNIQUES: &[AttackTechnique] = &[
    AttackTechnique {
        id: "T1001",
